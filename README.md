...
git init
git add .
git commit -m "Luxe Canvas shop with API and YooKassa"
git branch -M main
...
- [ ] ПВЗ: удалить демо, импортировать свои точки
...
- CDEK API и Meshy — следующие этапы после первой живой оплаты
